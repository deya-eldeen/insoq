//
//  NotificationFillterView.swift
//  inSooqApp
//
//  Created by mohammad ahmad on 05/05/2021.
//

import UIKit

class NotificationFillterView: UIView  {
    ...
    var testFilltered:[String]=["Chat messages","Ad Updates","Anniuncements"]
    ...
    func xibSetup() {
        Bundle.main.loadNibNamed("NotificationFillterView", owner: self, options: nil)
...
extension NotificationFillterView:UITableViewDataSource,UITableViewDelegate{
