...
class MotorsTableViewCell: UITableViewCell {
    ...
    func setViewData(motorsObject:MotorsModel){
        ...
        self.images=motorsObject.itemImages
...
extension MotorsTableViewCell: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
