//
//  PropertiresTableViewCell.swift
//  inSooqApp
//
...
class PropertiresTableViewCell: UITableViewCell{
...
extension PropertiresTableViewCell: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
