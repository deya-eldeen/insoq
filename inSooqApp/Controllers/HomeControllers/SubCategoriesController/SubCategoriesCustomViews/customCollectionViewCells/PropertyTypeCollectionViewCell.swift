...
class PropertyTypeCollectionViewCell: UICollectionViewCell {
    ...
    override var isSelected: Bool {
        didSet {
            ...
            self.categorylabel.textColor = isSelected ? #colorLiteral(red: 0.3411764706, green: 0.2745098039, blue: 0.9882352941, alpha: 0.4523653575) : #colorLiteral(red: 0.2549019754, green: 0.2745098174, blue: 0.3019607961, alpha: 1)
        }
    }
