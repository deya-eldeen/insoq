...
extension ApiRequests {
    ...
    static func nationalities(completion:@escaping (NationalitiesCompletionHandler) -> Void) {
        NetworkService.shared.simpleRequest(url: APIUrls.nationalities(), method: .get, withLoading: false) { (response: NationalitiesCompletionHandler) in completion(response) }
    }
    ...
    static func locations(completion:@escaping (LocationsCompletionHandler) -> Void) {
        NetworkService.shared.simpleRequest(url: APIUrls.locations(), method: .get, withLoading: false) { (response: LocationsCompletionHandler) in completion(response) }
    }
    ...
    static func educationLevels(completion:@escaping (EducationLevelsCompletionHandler) -> Void) {
        NetworkService.shared.simpleRequest(url: APIUrls.educationLevels(), method: .get, withLoading: false) { (response: EducationLevelsCompletionHandler) in completion(response) }
    }
    ...
    static func careerLevels(completion:@escaping (CareerLevelsCompletionHandler) -> Void) {
        NetworkService.shared.simpleRequest(url: APIUrls.careerLevels(), method: .get, withLoading: false) { (response: CareerLevelsCompletionHandler) in completion(response) }
    }
