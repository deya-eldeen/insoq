...
//  Edited by Marwan Abd-Alhadi on 10/25/20.
//
...
@IBDesignable
public final class CenteredTabBar: UITabBar {
...
//
//        path.addQuadCurve(to: CGPoint(x: halfW-f-10, y: (r/2.0)), controlPoint: CGPoint(x: halfW-f, y: 0))
//
//        path.addArc(withCenter: CGPoint(x: halfW, y: (r/2.0)), radius: f+2, startAngle: .pi, endAngle: 0, clockwise: false)
//
