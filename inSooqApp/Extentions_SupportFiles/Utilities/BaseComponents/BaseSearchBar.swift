...
//  orood
//
//  Created by Deya AlDeen on 18/07/2021.
//
import UIKit
...
class SearchBar: UISearchBar {
    ...
    public var textBGColor: UIColor?
    ...
    func applyTheme(themeColor: UIColor, textBGColor: UIColor){
        self.textBGColor           = textBGColor
        self.clearButtonColor      = themeColor
        self.cancelButtonColor     = themeColor
        self.searchIconColor       = themeColor
        self.placeholderColor      = themeColor
        self.textColor             = themeColor
        self.capabilityButtonColor = themeColor
    }
}
