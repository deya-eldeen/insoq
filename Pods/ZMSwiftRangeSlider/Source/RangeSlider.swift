...
open class RangeSlider: UIControl {
   ...
   @IBInspectable open var trackHighlightTintColor: UIColor = #colorLiteral(red: 0.3411764706, green: 0.2745098039, blue: 0.9882352941, alpha: 1) //UIColor(red:0.17, green:0.74, blue:0.39, alpha:1.00)
   {
        didSet {
            updateLayerFrames()
        }
